...
public class AbstractRunTestCases {
    public static void runTest(AbstractSmartContract sC, AbstractTransaction tR, int trNumber, boolean expectedResult){
    ...
    public static void runTestSuite(AbstractSmartContract sC, ArrayList<AbstractTransaction> transactions){
